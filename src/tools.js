...

  {
    ...
    inputSchema: {
      ...
      properties: {
        ...
        image_text_enabled: { type: 'boolean', default: true, description: 'Applies to every post generated by this campaign: false generates artwork with no text overlaid on the image. Changeable per post later with updatePost.' },
        image_logo_enabled: { type: 'boolean', default: true, description: 'Applies to every post generated by this campaign: false leaves the brand logo out of the generated artwork.' },
